...
namespace Resume.Infra.Data.Migrations
{
    ...
    [Migration("20240428201920_AddEmailSettingTable")]
    partial class AddEmailSettingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resume.Domain.Models.AboutMe", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("paragraf1")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("paragraf2")
                        .HasMaxLength(1000)
            ...
            modelBuilder.Entity("Resume.Domain.Models.ItemIDo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Resume.Domain.Models.SiteSetting.EmailSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnableSSl = true,
                            From = "resumehadifakhimi79@gmail.com",
                            IsDefault = true,
                            IsDelete = false,
                            Password = "wtay jwgz micf unit ",
                            Port = 587,
                            SMTP = "smtp.gmail.com"
                        });
                });
            ...
            modelBuilder.Entity("Resume.Domain.Models.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
